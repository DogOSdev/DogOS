...
namespace DogOS.Utils.Security
{
    // Based on https://github.com/aura-systems/Aura-Operating-System/blob/master/Aura%20Operating%20System/Aura_OS/System/Security/SHA256.cs
    // Which is based on https://github.com/yuriks/SHA2-Csharp
    // Under the MIT License by Yuri K. Schlesner
    public class Sha256
    {
        ...
        public static string ComputeHash(byte[] value)
        {
            ...
            string toreturn = Utils.Convert.Hex.BytesToHex(hash.GetHash());
